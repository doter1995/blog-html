...
window.onload = function () {
  ...
  function initChart() {
    ...
    line.append('rect')
      ...
      .on('mouseout', function (d, i) {
        d3.select(this).transition()
          .duration(100)
          .attr("height", 2)
        d3.select('#div_tip').style('display', 'none')
      })
    ...
    // 绘制XY提示线
    Tip.attr('transform', 'translate(' + marginLeft + ',' + marginTop + ')')
      .append('svg').attr('width', W).attr('height', H)
